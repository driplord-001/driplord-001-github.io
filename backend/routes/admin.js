...
// Admin middleware (check if user is admin – we can add a role column later)
const isAdmin = async (req, res, next) => {
  // For now, we'll hardcode an admin email check (or you can add a role column)
  ...
  // Example: allow only specific email
